...
<div class="main-header">
    ...
    <p>Tác giả: Ma Nhân Lý - Trường Tiểu học Minh Quang - ĐT: 0389 887 188</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  - Trường Ma Nhân Lý - Trường Tiểu học Minh Quang  - ĐT: 0389 887 188</div>", unsafe_allow_html=True)
